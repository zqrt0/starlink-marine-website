  ...
  const plans = [
    {
      ...
      price: '15 000',
      period: 'руб/мес',
      description: 'Идеально для частных яхт и катеров',
      features: [
    ...
    },
    {
      ...
      price: '25 000',
      period: 'руб/мес',
      description: 'Для рыболовных и средних коммерческих судов',
      features: [
        ...
        'Мобильное приложение',
        'Гарантия 99.5% времени работы',
        'Резервный канал связи'
      ],
      popular: true
    },
    {
      name: 'Коммерческое судно',
      price: '45 000',
      period: 'руб/мес',
      description: 'Для крупных коммерческих и грузовых судов',
      features: [
